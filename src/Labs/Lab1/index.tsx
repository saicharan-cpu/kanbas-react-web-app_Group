  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-h-tag">
        ...
        Each section is usually prefaced with a short title or heading that attempts to summarize the topic of 
        the section it precedes. For instance this paragraph is preceded by the heading Heading Tags. 
      ...
      <ol id="wd-my-favorite-recipe">
        <li>Make rice</li>
        <li>cook chicken and egg</li>
        <li>fry rice and chicken together</li>
      </ol>
      ...
      <br />
      <img id="wd-teslabot" src="/Users/saicharanreddy/Downloads/images.jpg" height="200px" />
     </div>
